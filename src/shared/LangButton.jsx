...
export const LangButton = () => {
  ...
  return (
    ...
    className="p-2 bg-transparent transition ease-in-out duration-300 hover:bg-gray-500 text-black dark:text-white font-semibold hover:text-white  border border-black dark:border-white hover:border-transparent rounded-[100%] cursor-pointer">  
