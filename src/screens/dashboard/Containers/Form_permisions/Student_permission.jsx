...
export const Student_permission = ({premission , handleCheckboxChange}) => {
  return (
    <>
    {premission.map((admin , index) => {
    if(admin.content_type_details.model === "student") {
     return  (
     <div key={index} className="w-full flex justify-between items-center gap-2 h-10 rounded-xl bg-opacity-0 shadow-xl bg-gray-950 p-4 my-4">
