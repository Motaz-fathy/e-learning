    ...
    <div className="w-full relative isolate px-6 pt-0 lg:px-8">
      ...
      <div className="w-full mx-auto   sm:py-48 ">
        ...
        <div className="text-center w-full ">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl max-w-2xl  mx-auto dark:text-white">
            Data to enrich your online business
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl  mx-auto dark:text-gray-400">
